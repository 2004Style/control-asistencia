...
import { AssistsModelTs } from '../../../models/assists.model';
import { AssistsService } from '../../../services/assists.service';
import { PageEvent } from '@angular/material/paginator';
@Component({
  selector: 'app-assists-admin',
  imports: [
    MatTableModule,
    MatIconModule,
    MatFormFieldModule,
  ...
  templateUrl: './assists-admin.component.html',
  styleUrl: './assists-admin.component.css',
})
export class AssistsAdminComponent {
  dataSource: MatTableDataSource<AssistsModelTs>;
  columnsDefinitions = [
    { def: 'idAssist', label: 'idAssist', hide: true },
    { def: 'status', label: 'status', hide: false },
    { def: 'idAttendance', label: 'idAttendance', hide: false },
    { def: 'id_enrollment', label: 'id_enrollment', hide: false },
  ...
  constructor(
    private _service: AssistsService,
  ...
  createTable(data: AssistsModelTs[]) {
