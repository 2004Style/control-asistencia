...
@Component({
  selector: 'app-assists-edit-admin',
  imports: [
    NgIf,
    ReactiveFormsModule,
    MatFormFieldModule,
  ...
  templateUrl: './assists-edit-admin.component.html',
  styleUrl: './assists-edit-admin.component.css',
})
export class AssistsEditAdminComponent {
  form: FormGroup;
  id: number;
  isEdit: boolean;
  ...
  operate() {
    const model = new AssistsDtoTs(this.form.value);
