...
@Component({
  ...
  styleUrl: './teachers-admin.component.css',
})
export class TeachersAdminComponent {
  dataSource: MatTableDataSource<TeachersModelTs>;
  columnsDefinitions = [
    { def: 'id_teacher', label: 'id_teacher', hide: true },
    { def: 'idPerson', label: 'idPerson', hide: false },
  ...
  createTable(data: TeachersModelTs[]) {
