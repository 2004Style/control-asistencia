...
@Component({
  selector: 'app-classrooms-edit-admin',
  imports: [
    NgIf,
    ReactiveFormsModule,
    MatFormFieldModule,
  ...
  templateUrl: './classrooms-edit-admin.component.html',
  styleUrl: './classrooms-edit-admin.component.css',
})
export class ClassroomsEditAdminComponent {
  form: FormGroup;
  id: number;
  isEdit: boolean;
  ...
  ngOnInit(): void {
    this._service
      ...
      .toPromise()
      .then(() => {
        const model = new ClassroomsDtoTs();
  ...
  operate() {
    const model = new ClassroomsDtoTs(this.form.value);
