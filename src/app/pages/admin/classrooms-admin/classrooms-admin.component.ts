...
@Component({
  ...
  styleUrl: './classrooms-admin.component.css',
})
export class ClassroomsAdminComponent {
  dataSource: MatTableDataSource<ClassroomsModelTs>;
  columnsDefinitions = [
    { def: 'classroomId', label: 'classroomId', hide: true },
    { def: 'name', label: 'name', hide: false },
    { def: 'id_subject', label: 'id_subject', hide: false },
    { def: 'id_teacher', label: 'id_teacher', hide: false },
  ...
  createTable(data: ClassroomsModelTs[]) {
