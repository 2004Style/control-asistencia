...
import { TardinessModelTs } from '../../../models/tardiness.model';
import { TardinessService } from '../../../services/tardiness.service';
import { PageEvent } from '@angular/material/paginator';

@Component({
  selector: 'app-tardiness-admin',
  imports: [
    MatTableModule,
    MatIconModule,
    MatFormFieldModule,
  ...
  templateUrl: './tardiness-admin.component.html',
  styleUrl: './tardiness-admin.component.css',
})
export class TardinessAdminComponent {
  dataSource: MatTableDataSource<TardinessModelTs>;
  columnsDefinitions = [
    { def: 'id_tardiness_rule', label: 'id_tardiness_rule', hide: true },
    {
      def: 'absence_threshold_minutes',
      label: 'absence_threshold_minutes',
      hide: false,
    },
    {
      def: 'tardinness_threshold_minutes',
      label: 'tardinness_threshold_minutes',
      hide: false,
    },
    {
      def: 'classroomId',
  ...
  constructor(
    private _service: TardinessService,
  ...
  createTable(data: TardinessModelTs[]) {
