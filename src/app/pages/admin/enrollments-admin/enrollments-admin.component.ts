...
@Component({
  ...
  styleUrl: './enrollments-admin.component.css',
})
export class EnrollmentsAdminComponent {
  dataSource: MatTableDataSource<EnrollmentModelTs>;
  columnsDefinitions = [
    { def: 'id_enrollment', label: 'id_enrollment', hide: true },
    { def: 'classroomId', label: 'classroomId', hide: false },
    { def: 'id_student', label: 'id_student', hide: false },
  ...
  createTable(data: EnrollmentModelTs[]) {
