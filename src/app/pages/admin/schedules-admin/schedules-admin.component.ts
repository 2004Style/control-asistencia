...
@Component({
  ...
  styleUrl: './schedules-admin.component.css',
})
export class SchemodulesAdminComponent {
  dataSource: MatTableDataSource<SchemodulesModelTs>;
  columnsDefinitions = [
    { def: 'idSchedule', label: 'idSchedule', hide: true },
    { def: 'dayOfWeek', label: 'dayOfWeek', hide: false },
    { def: 'endTime', label: 'endTime', hide: false },
    { def: 'startTime', label: 'startTime', hide: false },
  ...
  createTable(data: SchemodulesModelTs[]) {
