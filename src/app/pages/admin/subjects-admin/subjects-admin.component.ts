...
@Component({
  ...
  styleUrl: './subjects-admin.component.css',
})
export class SubjectsAdminComponent {
  dataSource: MatTableDataSource<SubjectsModelTs>;
  columnsDefinitions = [
    { def: 'id_subject', label: 'id_subject', hide: true },
  ...
  createTable(data: SubjectsModelTs[]) {
