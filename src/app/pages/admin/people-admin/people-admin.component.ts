...
@Component({
  ...
  styleUrl: './people-admin.component.css',
})
export class PeopleAdminComponent {
  dataSource: MatTableDataSource<PeopleModelTs>;
  columnsDefinitions = [
    { def: 'idPerson', label: 'idPerson', hide: true },
  ...
  createTable(data: PeopleModelTs[]) {
